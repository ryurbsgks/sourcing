...
app.get("/user/mypageCart", controllers.mypageCart);
...
app.post("/user/orderhistoryCancel", controllers.orderhistoryCancel);
...
app.post("/seller/reservationList", controllers.insertReservationList);
